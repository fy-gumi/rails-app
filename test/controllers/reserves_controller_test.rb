...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post reserves_url, params: { reserf: { financial_planner_id: @reserf.financial_planner_id, reserve_date: @reserf.reserve_date, time_zone_code: @reserf.time_zone_code, user_id: @reserf.user_id } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { financial_planner_id: @reserf.financial_planner_id, reserve_date: @reserf.reserve_date, time_zone_code: @reserf.time_zone_code, user_id: @reserf.user_id } }
