...
class FinancialPlannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create financial_planner" do
    assert_difference('FinancialPlanner.count') do
      post financial_planners_url, params: { financial_planner: { financial_planner_name: @financial_planner.financial_planner_name } }
    end
  ...
  test "should update financial_planner" do
    patch financial_planner_url(@financial_planner), params: { financial_planner: { financial_planner_name: @financial_planner.financial_planner_name } }
